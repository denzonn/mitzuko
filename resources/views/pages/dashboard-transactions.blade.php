                                        ...
                                        <div class="card card-list d-block">
                                            ...
                                            <span>
                                                <div class="d-flex align-items-center p-3 ">
                                                    ...
                                                    <div class="col-4 col-lg-4 col-md-4 d-flex justify-content-end">
                                                        <div class="row">
                                                            <a href="{{ route('payment', $transaction->id) }}"
                                                                class="btn btn-payment p-2 mb-lg-0 mb-2 mr-lg-1">
                                                                Bayar
                                                                Sekarang
                                                            </a>
                                                            {{-- Batalkan pesanan --}}
                                                            <a href="{{ route('dashboard-transaction-cancel', $transaction->id) }}"
                                            ...
                                            <span>
                                                <div class="d-flex align-items-center p-3 ">
                                                    ...
                                                    <div class="col-4 col-lg-4 col-md-4 text-right px-0">
                                                        <a href="{{ route('dashboard-transaction-success', $transaction->id) }}"
                                        ...
                                        <div class="card card-list d-block">
                                            ...
                                            <span>
                                                <div class="d-flex align-items-center p-3 ">
                                                    ...
                                                    <div class="col-4 col-lg-4 col-md-4 text-right px-0">
                                                        <a type="button" class="btn btn-payment p-2 mb-lg-0 mb-2">Beli
                                                            Lagi
                                                        </a>
                                                        <a type="button" class="btn btn-info p-2">
                                                            Rincian Pesanan
                                        ...
                                        <div class="card card-list d-block">
                                            ...
                                            <span>
                                                <div class="d-flex align-items-center p-3 ">
                                                    ...
                                                    <div class="col-4 col-lg-4 col-md-4 text-right px-0">
                                                        <a type="button" class="btn btn-payment p-2 mb-lg-0 mb-2">
                                                            Beli Lagi
                                                        </a>
                                                        <a type="button" class="btn btn-info p-2">
                                                            Rincian Pesanan
...
@push('addon-script')
    <script>
        ...
        $(document).on('click', '.cancelBtn', function(e) {
            ...
            Swal.fire({
                title: 'Apakah kamu yakin ingin membatalkan pesanan?',
                html: '<span class="text-muted" style="font-size: 14px;">Pesanan yang dibatalkan akan dihapuskan!</span>',
                icon: 'warning',
