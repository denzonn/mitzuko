                    ...
                    <div class="col-lg-4 pagee">
                        ...
                        <form class="mt-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control is-invalid" v-model="password" />
                            </div>
                            <div class="form-group">
                                <label>Phone Number</label>
                                <input type="number" class="form-control is-invalid" v-model="phone" />
                            </div>
